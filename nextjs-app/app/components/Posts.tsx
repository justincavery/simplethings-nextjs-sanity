...
export const AllPosts = async () => {
  ...
  return (
    <Posts
      heading="Blog posts from Simple Things"
      subHeading={`${data.length === 1 ? "This blog post is" : `These ${data.length} blog posts are`} carefully crafted from our Sanity CMS Studio.`}
    >
      {data.map((post: any) => (
